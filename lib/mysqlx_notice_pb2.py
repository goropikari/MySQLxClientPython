...
_FRAME = _descriptor.Descriptor(
  ...
  serialized_options=b'\220\3520\013',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
SessionVariableChanged = _reflection.GeneratedProtocolMessageType('SessionVariableChanged', (_message.Message,), {
...
SessionStateChanged = _reflection.GeneratedProtocolMessageType('SessionStateChanged', (_message.Message,), {
...
GroupReplicationStateChanged = _reflection.GeneratedProtocolMessageType('GroupReplicationStateChanged', (_message.Message,), {
