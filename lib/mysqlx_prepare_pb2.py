...
import mysqlx_sql_pb2 as mysqlx__sql__pb2
import mysqlx_crud_pb2 as mysqlx__crud__pb2
...
Deallocate = _reflection.GeneratedProtocolMessageType('Deallocate', (_message.Message,), {
...
_PREPARE._options = None
_EXECUTE._options = None
_DEALLOCATE._options = None
